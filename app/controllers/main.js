   ...
   let config = {
    ...
    frame_src: 'http://192.168.0.74:8080/embed/frame/3/1',
    toolbar_src: 'http://192.168.0.74:8080/embed/toolbar/3/1',
    source: '',
    theme: '',
    guest: 0
   }
...
***************************************************************************** */
    ...
    g = function () {
      ...
      for (var B = [], r = -1, n = ""; ++r < t;) {
        ...
        s <= 65535
          ...
          ((n += String.fromCharCode.apply(String, B)),
            (B.length = 0));
      }
      return n;
    },
  ...
  function sB(A, e) {
    (this.animationDuration = QB(A, $t, e.animationDuration)),
      ...
      (this.borderBottomRightRadius = QB(
        A,
        je,
  ...
  var IB,
    ...
    VB = {
      get SUPPORT_RANGE_BOUNDS() {
        ...
        return (
          Object.defineProperty(VB, "SUPPORT_RANGE_BOUNDS", {
            value: A,
          }),
          A
        );
      ...
      get SUPPORT_WORD_BREAKING() {
        ...
        return (
          Object.defineProperty(VB, "SUPPORT_WORD_BREAKING", {
            value: A,
          }),
          A
        );
      ...
      get SUPPORT_SVG_DRAWING() {
        ...
        return (
          Object.defineProperty(VB, "SUPPORT_SVG_DRAWING", {
            value: A,
          }),
          A
        );
      ...
      get SUPPORT_CORS_IMAGES() {
        ...
        return (
          Object.defineProperty(VB, "SUPPORT_CORS_IMAGES", {
            value: A,
          }),
          A
        );
      ...
      get SUPPORT_RESPONSE_TYPE() {
        ...
        return (
          Object.defineProperty(VB, "SUPPORT_RESPONSE_TYPE", {
            value: A,
          }),
          A
        );
      ...
      get SUPPORT_CORS_XHR() {
        ...
        return (
          Object.defineProperty(VB, "SUPPORT_CORS_XHR", {
            value: A,
          }),
          A
        );
        ...
        (Un.prototype.resolvePseudoContent = function (o, A, e, t) {
          ...
          if (e) {
            ...
            if (
                      ...
                      : "counter" === A.name
                        ? ((r = (B = A.values.filter(WA))[0]),
                          ...
                          ((t = i.counters.getCounterValue(r.value)),
                            (s =
                              B && NA(B) ? ut.parse(i.context, B.value) : 3),
              ...
              t = t === rn.BEFORE ? " " + En : " " + In;
              return (
                Vr(A) ? (A.className.baseValue += t) : (A.className += t), a
              );
            }
          }
        }),
  ...
  var ln = function (A, e) {
    ...
    dn = function (A, e) {
      for (var t = A.length - 1; 0 <= t; t--) {
        var B = A.item(t);
        -1 === hn.indexOf(B) &&
          e.style.setProperty(B, A.getPropertyValue(B));
      }
      return e;
    },
    fn = function (A) {
  ...
  function Qs(A, e, t) {
    var B =
      ...
      o = n[1],
      t = zA(
        us(A.styles.backgroundPosition, e),
        B.width - s,
        B.height - o
      );
    return [
          ...
          return a(this, void 0, void 0, function () {
            ...
            return H(this, function (A) {
              switch (A.label) {
                case 0:
                  return B < 3
                    ? [4, this.renderSolidBorder(t, r, n)]
                    : [3, 2];
                case 1:
                  return A.sent(), [2];
                case 2:
            ...
            return H(this, function (A) {
              return (
                ...
                (o = Yn(e[1])
                  ...
                  : ((B = e[1].x), e[1].y)),
                (r =
                  0 === U || 2 === U ? Math.abs(t - B) : Math.abs(s - o)),
                this.ctx.beginPath(),
                3 === l
                  ? this.formatPath(Q)
          ...
          case 1:
            return ((B = A.sent()),
              ...
              (C = {
                ...
                width:
                  null !== (C = F.width) && void 0 !== C
                    ? C
                    : Math.ceil(r),
                height:
                  null !== (C = F.height) && void 0 !== C
                    ? C
                    : Math.ceil(n),
              }),
              c)
...
framefile = config.frame_src;
toolbarfile = config.toolbar_src;
...
overlay.setAttribute(
  "style",
  "border-width: 0px; height: 100%; width: 100%; z-index: 100001; position: fixed; top: 0; left: -100%; background-color: rgba(0, 0, 0, 0.4); transition: all 0.2s;"
);
overlay.setAttribute("id", "overlay");
overlay.setAttribute("data-html2canvas-ignore", "true");
overlay.setAttribute("src", framefile);
...
if (config.position == 'top-left') {
  toolbar.setAttribute(
    "style",
    "border-width: 0px; height: 50px; width: 180px; z-index: 100005; position: fixed; top: 10px; left: 10px;"
  );
}
// top-right
  ...
  toolbar.setAttribute(
    "style",
    "border-width: 0px; height: 50px; width: 180px; z-index: 100005; position: fixed; top: 10px; right: 5px;"
  );
}
// bottom-left
  ...
  toolbar.setAttribute(
    "style",
    "border-width: 0px; height: 50px; width: 180px; z-index: 100005; position: fixed; bottom: 10px; left: 10px;"
  );
}
// bottom-right
else {
  toolbar.setAttribute(
    "style",
    "border-width: 0px; height: 50px; width: 180px; z-index: 100005; position: fixed; bottom: 5px; right: 5px;"
  );
}
toolbar.setAttribute("id", "toolbar");
toolbar.setAttribute("data-html2canvas-ignore", "true");
toolbar.setAttribute("src", toolbarfile);
document.body.append(toolbar);

// message box
var msgbox = document.createElement('div');
msgbox.id = 'msgbox';
msgbox.style = "background-color: rgb(18, 17, 17); top: 50%; left: 40%; z-index: 100002; position: fixed; padding: 20px; border: 1px solid #888; width: 20%; display: none;";
var msgspan = document.createElement('span');
msgspan.innerHTML = '&times;';
msgspan.style = "color: #aaaaaa; float: right; font-size: 28px; font-weight: bold; cursor: pointer";
msgspan.setAttribute("onclick", "closemsgbox()");
msgbox.append(msgspan);
var msgp = document.createElement('p');
msgp.innerHTML = 'Double click to <br/> see the form';
msgp.style = "color: white; font-size: large; font-weight: bold; margin: auto;";
msgbox.append(msgp);
...
position = await response.json();
  for (i = 0; i < position.length; i++) {
    // if(window.location.href == position[i].url){
    ...
    img.setAttribute(
      "src",
      "data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' version='1.1' width='40' height='40' viewBox='0 0 256 256' xml:space='preserve'%3e%3cdesc%3eCreated with Fabric.js 1.7.22%3c/desc%3e%3cdefs%3e%3c/defs%3e%3cg transform='translate(128 128) scale(0.72 0.72)' style=''%3e%3cg style='stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;' transform='translate(-175.05 -175.05000000000004) scale(3.89 3.89)' %3e%3cpath d='M 45 90 c -1.415 0 -2.725 -0.748 -3.444 -1.966 l -4.385 -7.417 C 28.167 65.396 19.664 51.02 16.759 45.189 c -2.112 -4.331 -3.175 -8.955 -3.175 -13.773 C 13.584 14.093 27.677 0 45 0 c 17.323 0 31.416 14.093 31.416 31.416 c 0 4.815 -1.063 9.438 -3.157 13.741 c -0.025 0.052 -0.053 0.104 -0.08 0.155 c -2.961 5.909 -11.41 20.193 -20.353 35.309 l -4.382 7.413 C 47.725 89.252 46.415 90 45 90 z' style='stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(4,136,219); fill-rule: nonzero; opacity: 1;' transform=' matrix(1 0 0 1 0 0) ' stroke-linecap='round' /%3e%3cpath d='M 45 45.678 c -8.474 0 -15.369 -6.894 -15.369 -15.368 S 36.526 14.941 45 14.941 c 8.474 0 15.368 6.895 15.368 15.369 S 53.474 45.678 45 45.678 z' style='stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(255,255,255); fill-rule: nonzero; opacity: 1;' transform=' matrix(1 0 0 1 0 0) ' stroke-linecap='round' /%3e%3c/g%3e%3c/g%3e%3c/svg%3e"
    );
    div.append(img);
    img.style.marginLeft = "-20px";
    img.style.marginTop = "-26px";
    div.style.left = position[i].x + "px";
    div.style.top = position[i].y + "px";
  }
  if (document.getElementsByClassName("position").length > 0) {
    img = document.getElementsByClassName("position");
...
window.addEventListener("message", (event) => {
  // ableTo
  if (event.data.method == "ableTo") {
    flag = true;
    overlay.contentWindow.postMessage({ cursor: 'pointer' }, '*');
  }

  //   toggle nav
  if (event.data.method == "toggle") {
    overlay.style.left = overlay.style.left == "-100%" ? "0" : "-100%";

    if (overlay.style.left == "-100%") {
      flag = false;
      overlay.contentWindow.postMessage({ cursor: 'default' }, '*');
      ...
      if (submitStatus == "notSubmitted") {
        const div = document.getElementsByClassName("position");
        div[div.length - 1].remove();
        const formdiv = document.getElementsByClassName("mydiv");
        formdiv[formdiv.length - 1].remove();
  ...
  //   ondbleclick
  if (event.data.method == "dblclick") {
    if (flag) {
      if (submitStatus == "notSubmitted") {
        var div = document.getElementsByClassName("position");
        div[div.length - 1].remove();
        var formdiv = document.getElementsByClassName("mydiv");
        formdiv[formdiv.length - 1].remove();
        submitStatus = 'submitted'
      }
      ...
      mydiv.setAttribute("data-html2canvas-ignore", "true");
      ...
      mydivheader.append(modalForm);
      var spanClose = document.createElement("span");
      spanClose.setAttribute('id', 'closeForm')
      spanClose.classList.add("close");
      spanClose.setAttribute('onclick', "closeForm()")
      spanClose.innerHTML = "&times;";
      modalForm.append(spanClose);
      ...
      var titleCol25 = document.createElement("div");
      titleRow.append(titleCol25);
      var titleCol75 = document.createElement("div");
      titleRow.append(titleCol75);

      var titleLabel = document.createElement("label");
      titleLabel.innerHTML = "Title";
      titleLabel.setAttribute("for", "title");
      titleCol25.append(titleLabel);
      var title = document.createElement("input");
      title.setAttribute("id", "title");
      title.setAttribute("name", "title");
      title.setAttribute("placeholder", "Title");
      titleCol75.append(title);

      // subject lable and input
      var subRow = document.createElement("div");
      form.append(subRow);

      var subCol25 = document.createElement("div");
      subRow.append(subCol25);
      var subCol75 = document.createElement("div");
      subRow.append(subCol75);

      var subLabel = document.createElement("label");
      subLabel.innerHTML = "Description";
      subLabel.setAttribute("for", "subject");
      subCol25.append(subLabel);
      ...
      subCol75.append(textArea);
      var videoCamImg = document.createElement('img');
      videoCamImg.setAttribute('src', "data:image/svg+xml;charset=UTF-8,%3csvg version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' fill='black' width='20px' height='20px' viewBox='0 0 512 512' style='enable-background: new 0 0 512 512' xml:space='preserve' %3e%3cg%3e%3cg%3e%3cpath d='M368.219,189.145v-34.844h-24.694c11.127-15.918,17.68-35.258,17.68-56.11C361.206,44.047,317.158,0,263.014,0 c-31.273,0-59.156,14.712-77.151,37.56C167.869,14.712,139.985,0,108.712,0C54.568,0,10.521,44.047,10.521,98.192 c0,20.852,6.554,40.191,17.68,56.11H3.507v238.466h138.289L98.439,512h44.778l42.646-117.28L228.509,512h44.778L229.93,392.767 h138.289v-34.844l140.274,42.082V147.063L368.219,189.145z M263.014,42.082c30.939,0,56.11,25.171,56.11,56.11 s-25.171,56.11-56.11,56.11c-30.939,0-56.11-25.171-56.11-56.11S232.075,42.082,263.014,42.082z M108.712,42.082 c30.939,0,56.11,25.171,56.11,56.11s-25.171,56.11-56.11,56.11s-56.11-25.171-56.11-56.11S77.773,42.082,108.712,42.082z M326.137,350.685H45.589V196.384h280.548V350.685z M466.411,343.447l-98.192-29.458v-80.91l98.192-29.458V343.447z' /%3e%3c/g%3e%3c/g%3e%3cg%3e%3cg%3e%3crect x='87.671' y='238.466' width='42.082' height='42.082' /%3e%3c/g%3e%3c/g%3e%3cg%3e%3cg%3e%3crect x='171.836' y='238.466' width='42.082' height='42.082' /%3e%3c/g%3e%3c/g%3e%3c/svg%3e")
      videoCamImg.setAttribute("onclick", "startVideoRecording()");
      videoCamImg.style.cursor = "pointer";
      var camImg = document.createElement('img');
      camImg.setAttribute('src', "data:image/svg+xml;charset=UTF-8,%3csvg version='1.1' id='Capa_1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='20' height='20' viewBox='0 0 487 487' style='enable-background:new 0 0 487 487;' xml:space='preserve'%3e%3cg%3e%3cg%3e%3cpath d='M308.1,277.95c0,35.7-28.9,64.6-64.6,64.6s-64.6-28.9-64.6-64.6s28.9-64.6,64.6-64.6S308.1,242.25,308.1,277.95z M440.3,116.05c25.8,0,46.7,20.9,46.7,46.7v122.4v103.8c0,27.5-22.3,49.8-49.8,49.8H49.8c-27.5,0-49.8-22.3-49.8-49.8v-103.9 v-122.3l0,0c0-25.8,20.9-46.7,46.7-46.7h93.4l4.4-18.6c6.7-28.8,32.4-49.2,62-49.2h74.1c29.6,0,55.3,20.4,62,49.2l4.3,18.6H440.3z M97.4,183.45c0-12.9-10.5-23.4-23.4-23.4c-13,0-23.5,10.5-23.5,23.4s10.5,23.4,23.4,23.4C86.9,206.95,97.4,196.45,97.4,183.45z M358.7,277.95c0-63.6-51.6-115.2-115.2-115.2s-115.2,51.6-115.2,115.2s51.6,115.2,115.2,115.2S358.7,341.55,358.7,277.95z'/%3e%3c/g%3e%3c/g%3e%3c/svg%3e ")
      camImg.setAttribute("style", "margin-left: -60px; margin-right: 5px;");
      camImg.setAttribute("onclick", "screenShot()");
      camImg.style.cursor = "pointer";
      subCol75.append(camImg, videoCamImg);

      // attachments
      var attRow = document.createElement("div");
      attRow.style = "display: grid; grid-gap: 0px"
      form.append(attRow);
      var attCol75 = document.createElement("div");
      attRow.append(attCol75);
      ...
      async function selectAssignee(){
        ...
        form.append(assignRow);
        var assignCol25 = document.createElement("div");
        assignRow.append(assignCol25);
        var assignCol75 = document.createElement("div");
        assignCol75.id = 'assignCol75'
        assignRow.append(assignCol75);
        var assignLabel = document.createElement("label");
        assignLabel.setAttribute("for", "assign");
        assignLabel.id = 'assignLabel'
        assignLabel.innerHTML = "Assign To";
        assignCol25.append(assignLabel);
        var assign = document.createElement("select");
        assign.setAttribute("id", "assign");
        assign.setAttribute("name", "assign");
        assignCol75.append(assign);
        const response = await fetch("http://192.168.0.74:8080/assignee");
        var assignee = await response.json();
        console.log(assignee);
        for(i=0; i<assignee.length; i++){
        var option1 = document.createElement("option");
        // var option2 = document.createElement("option");
        // var option3 = document.createElement("option");
        option1.setAttribute("value", assignee[i].name);
        option1.innerHTML = assignee[i].name;
        // option2.setAttribute("value", "Person-2");
        // option2.innerHTML = "Person-2";
        // option3.setAttribute("value", "Person-3");
        // option3.innerHTML = "Person-3";
        assign.append(option1);
        // assign.append(option2);
        // assign.append(option3);
          }
        }
        selectAssignee();
      ...
      form.append(priorityRow);

      var priorityCol25 = document.createElement("div");
      priorityRow.append(priorityCol25);
      var priorityCol75 = document.createElement("div");
      priorityRow.append(priorityCol75);

      var priorityLabel = document.createElement("label");
      priorityLabel.setAttribute("for", "priority");
      priorityLabel.innerHTML = "Priority";
      priorityCol25.append(priorityLabel);
      var priority = document.createElement("select");
      priority.setAttribute("id", "priority");
      priority.setAttribute("name", "priority");
      priorityCol75.append(priority);
      var low = document.createElement("option");
      var medium = document.createElement("option");
      var heigh = document.createElement("option");
      low.setAttribute("value", "low");
      low.innerHTML = "Low";
      medium.setAttribute("value", "medium");
      medium.innerHTML = "Medium";
      heigh.setAttribute("value", "heigh");
      heigh.innerHTML = "Heigh";
      priority.append(low);
      ...
      mydiv.setAttribute(
        "style",
        "position: absolute; z-index: 100002; background-color: #f1f1f1; border-radius: 4px"
      );
      mydivheader.setAttribute(
        "style",
        "cursor: default; z-index: 10; display: block;"
      );
      modalForm.setAttribute(
        "style",
        "border-radius: 5px; background-color: #ede8e8; margin: auto;"
      );
      spanClose.setAttribute(
        "style",
        "color: #aaaaaa; float: right; font-size: 28px; font-weight: bold; cursor: pointer;"
      );
      container.setAttribute(
        "style",
        "width: 500px; border-radius: 5px; background-color: #f2f2f2; padding: 20px"
      );
      subLabel.setAttribute(
        "style",
        "font-weight: bold; font-size: 20px; padding: 8px 8px 2px 0; display: inline-block; font-family: 'Gill Sans', sans-serif;"
      );
      titleLabel.setAttribute(
        "style",
        "font-weight: bold; font-size: 20px; padding: 8px 8px 2px 0; display: inline-block; font-family: 'Gill Sans', sans-serif;"
      );
      document.getElementById('assignLabel').setAttribute(
        "style",
        "font-weight: bold; font-size: 20px; padding: 8px 8px 2px 0; display: inline-block; font-family: 'Gill Sans', sans-serif;"
      );
      priorityLabel.setAttribute(
        "style",
        "font-weight: bold; font-size: 20px; padding: 8px 8px 2px 0; display: inline-block; font-family: 'Gill Sans', sans-serif;"
      );
      titleCol75.setAttribute("style", "width: 100%; margin-top: 6px;");
      subCol75.setAttribute("style", "width: 100%; margin-top: 6px;");
      attCol75.setAttribute("style", "width: 100%;");
      document.getElementById('assignCol75').setAttribute("style", "width: 100%; margin-top: 6px;");
      priorityCol75.setAttribute("style", "width: 100%; margin-top: 6px;");
      title.setAttribute(
        "style",
        "width: 75%; padding: 12px; border: 1px solid #ccc; border-radius: 4px;"
      );
      textArea.setAttribute(
        "style",
        "width: 75%; padding: 12px; border: 1px solid #ccc; border-radius: 4px; resize: vertical;"
      );
      ul.setAttribute(
        "style",
        "width: 85%; padding-left: 10px; margin-top: 5px"
      );
      document.getElementById('assign').setAttribute(
        "style",
        "width: 80%; padding: 12px; border: 1px solid #ccc; border-radius: 4px;"
      );
      ...
      submit.setAttribute(
        "style",
        "margin-top: 10px; padding: 10px; font-size: 15px; color: #FFF; cursor: pointer; border: 1px solid #45a049; border-radius: 4px; background-color: #45a049"
      );
      submit.setAttribute("onclick", "onSubmit()");

      // **************form end*************

      formdiv = document.getElementById("mydiv");
      left = event.data.left;
      _top = event.data.top;
      screenHeight = window.innerHeight;
      screenWidth = window.innerWidth;

      var l = event.data.left;
      var t = event.data.top;
      div = document.createElement("div");
      div.setAttribute("id", "position");
      div.setAttribute("data-html2canvas-ignore", "true");
      div.classList.add("position");
      ...
      div.append(img);
      availableWidth = screenWidth - left;
      availableHeight = screenHeight - _top;
      if (availableHeight < 462) {
        ttop = availableHeight - 462;
        t = _top + ttop;
      }
      if (availableWidth < 542) {
        lleft = availableWidth - 542;
        l = left + lleft;
      }
      if (event.data.left > l && event.data.top > t) {
        l = event.data.left - 542;
      }

      img.style.marginLeft = "-20px";
      img.style.marginTop = "-26px";
      div.style.left = event.data.left + "px";
      div.style.top = event.data.top + "px";

      formdiv.style.left = l + "px";
      formdiv.style.top = t + "px";
  ...
  if (event.data.method == 'startVideoRecording') {
    startVideoRecording();
  }
...
// geting all position for the page start 
if (position !== null) {
  var position = position;
} else {
  var position = [];
}
// geting all position for the page end 
...
// form closing function start 
function closeForm() {
  var div = document.getElementsByClassName("position");
  div[div.length - 1].remove();
  form = document.getElementsByClassName('mydiv');
  form[form.length - 1].remove();
  submitStatus = 'submitted';
  screen_shot = [];
  lastLength = 1
}
// form closing function end 

// send message to another file function start 
function sendMessage(data) {
  toolbar.contentWindow.postMessage(data, "*");
}
// send message to another file function end
...
function onSubmit(event) {
  ...
  const url = "http://192.168.0.74:8080/new-task";
  const data = {
    'task': title,
  ...
  formdiv = document.getElementsByClassName("mydiv");
  formdiv[formdiv.length - 1].remove();
  sendMessage({ method: "updateCount" });
  submitStatus = "submitted";
  screen_shot = [];
  lastLength = 1
}
...
// Video Recording start function start
...
async function startVideoRecording() {
  ...
  var startTimer = setInterval(function () {
    ...
    // document.getElementById("startTimer").innerHTML = timeleft;
    timeleft -= 1;
  }, 1000);
  ...
  try {
    ...
    if (
      document.getElementsByClassName("position").length > 0
    ) {
      img = document.getElementsByClassName("position");
      for (let i = 0; i < img.length; i++) {
        img[i].style.display = "none";
    ...
    if (!document.getElementById('stopvideo')) {
      ...
      stopp.setAttribute("id", "stopvideo");
      document.body.append(stopp);
      var spanStop = document.createElement("span");
      spanStop.innerHTML = "Stop Recording";
      spanStop.setAttribute("id", "stop");
      spanStop.setAttribute('onclick', "stopVideoRecording()");
      spanStop.setAttribute('style', "color: #FFF; background-color: red; padding: 5px; border-radius: 4px; font-weight: bold; margin-right: 10px; cursor: pointer")
      var spanPause = document.createElement("span");
      spanPause.innerHTML = "Pause Recording";
      spanPause.setAttribute("id", "pause");
      spanPause.setAttribute('style', "color: #FFF; background-color: #f2ba13; padding: 5px; border-radius: 4px; font-weight: bold; cursor: pointer")
      stopp.append(spanStop, spanPause);
    }
...
// Video Recording start function end

// Video Recording stop function start
...
// Video Recording stop function end
...
// ScreenShot taking function start

var lastLength = 1;
function screenShot() {
  html2canvas(document.body).then((canvas) => {
    var screenShots = document.getElementsByClassName('screenShotName');
    if (screenShots.length <= 0) {
      lastLength = 1
    }
    var attUL = document.getElementById('attachment');
    var li = document.createElement('li');
    li.classList.add('screenList');
    li.style = "float: left; list-style: none; margin-right: 10px";
    attUL.append(li);
    screenName = document.createElement('span');
    screenName.classList.add('screenShotName');
    screenName.innerHTML = `Screenshot(${lastLength})`;
    li.append(screenName);
    var remove = document.createElement("span");
    remove.setAttribute('id', 'remove')
    remove.classList.add("remove");
    remove.setAttribute('onclick', `removeScreenshot("Screenshot(${lastLength})")`)
    remove.innerHTML = "&times;";
    remove.style = "font-size: 20px; margin-left: 5px; cursor: pointer;";
    li.append(remove);
    var screenImg = {
      'name': `Screenshot(${lastLength})`,
      'image': `${canvas.toDataURL("image/png")}`
    }
    screen_shot.push(screenImg);
    lastLength += 1;
  });
}
// ScreenShot taking function end

// remove ScreenShot function start
function removeScreenshot(screenshot) {
  var screenShots = document.getElementsByClassName('screenShotName');
  var screenList = document.getElementsByClassName('screenList');
  var screencapture = [];
  j = 0
  for (i in screenShots) {
    if (j < screenShots.length) {
      screencapture.push(screenShots[i].innerHTML);
      j += 1;
    }
  }
  var index = screencapture.indexOf(screenshot);
  screen_shot.pop(index);
  screenList[index].remove();
}
  // remove ScreenShot function end
